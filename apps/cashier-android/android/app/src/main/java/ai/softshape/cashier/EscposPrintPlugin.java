 ...
 * Network printing is the primary local print path when the edge server
 * is unreachable — the cashier can print directly to a kitchen/bar printer
 * on the LAN via TCP port 9100.
 *
 * Bluetooth/USB printing requires native hardware APIs and is left as a stub.
 */
