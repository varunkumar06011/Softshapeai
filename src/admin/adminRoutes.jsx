...
export const adminRoutes = [
  ...
  { key: 'reports',           label: 'Reports',                icon: ChartNoAxesCombined, roles: ['admin','owner','manager'], element: <Reports />,                      source: 'cloud' },
  { key: 'balanceSheet',      label: 'Daily Balance Sheet',    icon: Scale,               roles: ['admin','owner','manager'], element: <AdminDailyBalanceSheet />,       source: 'cloud', group: 'finance' },
  { key: 'staff',             label: 'Staff',                  icon: Users,               roles: ['admin','owner','manager'], element: <StaffManagement />,              source: 'local', group: 'hr' },
  { key: 'captains',          label: 'Captain Analytics',      icon: ChartNoAxesCombined, roles: ['admin','owner','manager'], element: <CaptainPerformanceDashboard />,  source: 'cloud' },
  { key: 'payroll',           label: 'Payroll',                icon: DollarSign,          roles: ['admin','owner','manager'], element: <Payroll />,                       source: 'cloud', props: (ctx) => ({ onPayslip: () => {} }), group: 'hr' },
  { key: 'vouchers',          label: 'Expenditures',           icon: Wallet,              roles: ['admin','owner','manager'], element: <AdminExpenditures />,            source: 'cloud', group: 'finance' },
  { key: 'opening-balance',   label: 'Opening Balances',       icon: Landmark,            roles: ['admin','owner','manager'], element: <OpeningBalanceSetup />,          source: 'cloud', group: 'finance' },
  { key: 'purchases',         label: 'Purchases',              icon: Package,             roles: ['admin','owner','manager'], element: <AdminPurchases />,               source: 'cloud', group: 'finance' },
  { key: 'assets-liabilities', label: 'Assets & Liabilities',    icon: Building2,           roles: ['admin','owner','manager'], element: <AdminAssetsLiabilities />,     source: 'cloud', group: 'finance' },
  { key: 'cogs',              label: 'COGS Report',             icon: TrendingDown,        roles: ['admin','owner','manager'], element: <AdminCogsReport />,             source: 'cloud', group: 'finance' },
  { key: 'audit-trail',        label: 'Audit Trail',             icon: ClipboardList,       roles: ['admin','owner','manager'], element: <AdminAuditTrail />,             source: 'cloud', group: 'finance' },
  { key: 'reconciliation',     label: 'Reconciliation',          icon: Scale,               roles: ['admin','owner','manager'], element: <AdminReconciliation />,         source: 'cloud', group: 'finance' },
  { key: 'attendance',        label: 'Attendance',             icon: Users,               roles: ['admin','owner','manager'], element: <Attendance />,                    source: 'cloud', group: 'hr' },
