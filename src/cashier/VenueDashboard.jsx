 ...
 * Supports: Conference Hall, PDR, Rooms, GoBox.
 *
 * Features:
 * - Section tabs (Conference Hall / PDR / Rooms / GoBox)
...
const SECTION_ORDER = ['Conference Hall', 'PDR', 'Rooms', 'GoBox'];
const SECTION_COLORS = {
  ...
  'GoBox':           { bg: 'bg-amber-50',  border: 'border-amber-300',  text: 'text-amber-700',  active: 'bg-[#E65100]' },
};
...
function getTableLabel(sectionName, tableNumber) {
  ...
  if (sectionName === 'GoBox') return `GB${tableNumber}`;
