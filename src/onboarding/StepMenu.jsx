...
import { Utensils, Plus, Trash2, Upload, Leaf, Wine } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2 bg-gray-100 p-1 rounded-xl">
        ...
        <button
          ...
          className={`flex-1 py-2 px-4 rounded-lg transition-all ${mode === 'upload' ? 'bg-[#E53935] text-white' : 'text-gray-500 hover:text-gray-900'}`}
        >
          Upload JSON
        </button>
      </div>
